  ...
  export default {
    ...
    methods: {
      ...
      fillGraphData: function () {
        ...
        //  console.log("TimeSeriesAnalysisGraph::rendering Start");
        //  };
        // });
        ...
        for(var i = 0; i < keys.length; i++) {
          ...
          labels = Object.keys(dataDetails[i]);
          var data = [];
      ...
      async getData() {
        // TimeSeriesAnalysisGraphからならAPI呼び出し
      ...
      rendering : function() {
        ...
        this.$nextTick(function () {
          console.log("TimeSeriesAnalysisGraph::rendering nextTick Start");
          if (this.tabInfo.isLoaded) {
            this.fillGraphData();
            console.log("TimeSeriesAnalysisGraph::rendering nextTick is loaded");
            return;
          }
          console.log("TimeSeriesAnalysisGraph::rendering nextTick 1");
          ...
          console.log("TimeSeriesAnalysisGraph::rendering nextTick 2");
          (async () => {
            this.page_ready_flg = false;
            console.log("TimeSeriesAnalysisGraph::rendering nextTick async 1");
            let res = await this.getData();
            console.log("TimeSeriesAnalysisGraph::rendering nextTick async 2");
            this.hasApiError = (res.err_flg == 1);
            if (this.hasApiError) {
              console.log("TimeSeriesAnalysisGraph::rendering nextTick async haserror");
            ...
            console.log("TimeSeriesAnalysisGraph::rendering nextTick async 3");
            this.responseData = res.data;
            console.log("TimeSeriesAnalysisGraph::rendering nextTick async 4");
            this.fillGraphData();
            console.log("TimeSeriesAnalysisGraph::rendering nextTick async 5");
            this.page_ready_flg = true;
          })();
          console.log("TimeSeriesAnalysisGraph::rendering nextTick End");
        });
        console.log("TimeSeriesAnalysisGraph::rendering End");
      }
    },
    /**
     * mount時の処理
    ...
    mounted() {
      ...
      console.log("TimeSeriesAnalysisGraph::mounted Start");
      this.rendering();
      console.log("TimeSeriesAnalysisGraph::mounted End");
    },
    watch: {
      tabInfo: {
        handler: function() {
          console.log("TimeSeriesAnalysisGraph::watch tabInfo Start");
          this.rendering();
          console.log("TimeSeriesAnalysisGraph::watch tabInfo End");
        },
        deep: true
      },
    },
